...
const NATION_STATS = {
  ...
  military:{name:"兵力",icon:"",color:"#c0563a"},
  people:  {name:"民心",icon:"",color:"#5aa06a"},
  food:    {name:"粮草",icon:"",color:"#c79a5a"},
  land:    {name:"疆域",icon:"",color:"#7a9bd0"},
...
const PHASES = [
  ...
  {key:"noon",name:"正午",icon:"",hint:"日上中天，正宜理政"},
...
const BONDS = [
  {id:"b_wenwu", name:"出将入相", icon:"相", desc:"文官、武将各 ≥3 人在朝 → 国库 +2 · 兵力 +2 /月",
  ...
  {id:"b_loyal", name:"上下同心", icon:"忠", desc:"全体朝臣忠诚 ≥70 → 百官野心 −2 · 招贤点 +1 /月",
    cond:s=>s.ministers.length>0 && s.ministers.every(m=>m.loyalty>=70)},
  {id:"b_arms",  name:"神兵在握", icon:"兵", desc:"≥3 位将相佩兵器（兵器谱·套装）→ 兵力 +1 · 威望 +1 /月",
 ...
 {id:"hongfu", name:"苏蘅", portrait:_PC+"hongfu_neutral.jpg", origin:"maid", woo:"charm", beauty:84, joinRank:0,
  ...
  scenes:[
   {at:25,title:"掖庭抄检",text:"掌百官名册的女史苏蘅，仅凭只言片语便能道出某官贤愚高下，分毫不差。你立于廊下听了半晌，暗暗称奇。",
    script:[
     {cg:"1", txt:"掖庭深处，廊庑寂寂。你信步而过，忽闻一阵清越女声，正逐条点评着百官名册。"},
     {who:"苏蘅", face:"pensive", txt:"户部李员外……外宽内忌，理财尚可，独断则误事。"},
     {txt:"你驻足廊下，见那女子手不释卷，所断竟与你心中评判分毫不差。"},
     {who:"苏蘅", face:"neutral", txt:"吏部周主事……资历虽浅，然刚直敢任，假以时日可大用。"},
     {who:"你", txt:"（这些人朕都未必尽识……她一介掖庭女史，何以洞若观火？）"},
     {who:"你", txt:"姑娘只凭名册数行，便能定人贤愚？"},
     {who:"苏蘅", face:"smile", txt:"识人如识字，看的是骨，不是面。字有筋骨，人有心性——藏不住的。"},
     {who:"苏蘅", face:"neutral", txt:"陛下驾临，妾失仪了。"}],
   ...
   {at:55,title:"荐贤一语",text:"你为一桩任命踌躇不决，苏蘅从旁一语中的；所荐之人到任，果然称职。她浅笑：「识人如识字，看的是骨，不是面。」",
    script:[
     {cg:"2", txt:"是夜，烛火摇红。一桩封疆大吏的任命，你迟迟难决，索性召她近前参详。"},
     {who:"你", txt:"二人资历相当，朕委决不下。苏蘅，你怎么看？"},
     {who:"苏蘅", face:"pensive", txt:"张济务实而失之拘谨，守成有余；陈彦锋锐而略狂，开拓正需此人。边事方殷——当用陈彦。"},
     {txt:"你依其言。半年后捷报传来，那人果然不负所托。"},
     {who:"苏蘅", face:"smile", txt:"妾不过是替陛下，把人心多看了一层罢了。"},
     {who:"你", txt:"（这般见识，埋没于掖庭故纸，未免可惜……）"},
     {who:"你", txt:"朕若以国事相托，你可愿意？"},
     {who:"苏蘅", face:"blush", txt:"妾一介罪臣之后，蒙陛下不弃……敢不尽心。"}],
   ...
   {at:85,title:"知遇之许",text:"苏蘅本是罪臣之后、没入掖庭，你不究其出身、唯重其才。今夜她盈盈下拜：愿为君识尽天下英才，不负这一段知遇……",join:true,
    script:[
     {cg:"3", txt:"夤夜，宫灯如昼。苏蘅一袭素衣，盈盈拜倒在丹墀之下。"},
     {who:"苏蘅", face:"pensive", txt:"妾之父，当年以直言获罪，满门没入掖庭。妾本以为，此生只能与名册故纸为伴。"},
     {who:"苏蘅", face:"neutral", txt:"是陛下……不究妾的出身，只重妾的才识。"},
     {who:"你", txt:"骨相清贵者，岂因一时浮尘而失其光？朕要的是真才，不是门第。"},
     {txt:"她缓缓抬头，眼中似有微光闪动。"},
     {who:"苏蘅", face:"blush", txt:"得遇明主，妾……三生有幸。"},
 ...
 {id:"luofu", name:"阮陌桑", portrait:_PC+"luofu_neutral.jpg", origin:"common", woo:"int", beauty:82, joinRank:1,
  ...
  scenes:[
   {at:25,title:"陌上问桑",text:"微服出郊，见城南采桑女阮陌桑指点农事、调度乡邻，井井有条，老圃少壮无不心服。你看得入了神。",
    script:[
     {cg:"1", txt:"微服出郊，城南桑陌青青。一名采桑女子正指点农事、调度乡邻，老圃少壮无不心服。"},
     {who:"你", txt:"（一个采桑村女，竟能把一乡农事理得这般井井有条……）"},
     {who:"阮陌桑", face:"neutral", txt:"这位公子面生。看你这双手，不像握过锄头的。"},
     {who:"你", txt:"姑娘好眼力。在下……只是路过，见姑娘调度有方，一时看住了。"},
     {who:"阮陌桑", face:"smile", txt:"庄稼人的道理不深：人误地一时，地误人一年。你用心，它就长给你看。"}],
    choices:[{text:"下马问其姓字",eff:{}},{text:"远观而不渎",eff:{people:+2}}]},
   {at:55,title:"一乡之望",text:"那年蚕事歉收，陌桑倾己之储分与四邻，又传授养蚕新法，全乡赖以度荒——你方知这采桑女有济世之心。",
    script:[
     {cg:"2", txt:"那年蚕事歉收，四邻愁云惨淡。阮陌桑倾尽自家积储分与乡邻，又把新得的养蚕之法倾囊相授。"},
     {txt:"全乡赖她度过荒年。你这才知道，这采桑女子有一颗济世之心。"},
     {who:"你", txt:"自家也不宽裕，何苦倾储助人？"},
     {who:"阮陌桑", face:"neutral", txt:"一家饱不算饱，一乡安才算安。公子若坐在高处，也该懂这个理。"},
     {who:"阮陌桑", face:"pensive", txt:"……我总觉得，公子不是寻常人。"}],
   ...
   {at:85,title:"布衣之约",text:"你撤去仪仗、备六礼亲迎，陌桑不慕宫阙之华，唯念你「肯为农桑俯身」之诚，红妆出阁……",join:true,
    script:[
     {cg:"3", txt:"你撤去仪仗，备六礼，以布衣之身亲迎。阮陌桑红妆出阁，却不见半分攀附宫阙的欢喜。"},
     {who:"阮陌桑", face:"neutral", txt:"我嫁的，不是九重宫阙，也不是那身龙袍。"},
     {who:"你", txt:"那是什么？"},
     {who:"阮陌桑", face:"smile", txt:"是那个肯为农桑俯下身、肯把一乡一亩放在心上的人。"},
     {txt:"她将一束新采的桑叶，轻轻放入你掌心。"},
 ...
 {id:"hongxian", name:"慕容璇", portrait:_PC+"hongxian_neutral.jpg", origin:"maid", woo:"martial", beauty:80, joinRank:2,
  ...
  scenes:[
   {at:25,title:"青衣藏锋",text:"一名青衣婢女慕容璇，举止矫健异于常人。某夜你见她飞身越脊、瞬息往返，落地无声——竟是身负绝艺的女侠。",
    script:[
     {cg:"1", txt:"三更梆响，宫墙寂寂。你凭栏未眠，忽见一道青影掠过飞檐，瞬息往返，落地竟无半点声息。"},
     {who:"你", txt:"（一个洒扫的青衣婢女……竟有这等身手？）"},
     {txt:"那婢女察觉殿上有人，身形一顿，旋即垂手立定，恢复了寻常的恭谨。"},
     {who:"慕容璇", face:"pensive", txt:"奴婢夜巡至此，惊扰圣驾，万死。"},
     {who:"你", txt:"夜巡？你那一手越脊穿廊的功夫，也是洒扫宫人该会的？"},
     {who:"慕容璇", face:"neutral", txt:"……陛下既已看见，奴婢不敢欺瞒。只是这身微末武艺，于陛下无害。"},
     {who:"慕容璇", face:"neutral", txt:"奴婢只求安分当差，别无他图。"}],
    choices:[{text:"识破而不点破",eff:{}},{text:"延入内廷，以礼相询",eff:{}}]},
   {at:55,title:"夜阑潜锋",text:"边镇藩帅蓄异志，慕容璇一夜往返三百里，留一柄短匕于其枕畔以示警，不血刃而折其骄横之心。",
    script:[
     {cg:"2", txt:"边镇藩帅拥兵自重，渐露不臣之心。你正为此忧烦，慕容璇悄然请命。"},
     {who:"慕容璇", face:"neutral", txt:"陛下不必动刀兵。给奴婢三夜。"},
     {txt:"三日后她归来，未损一兵一卒。"},
     {who:"慕容璇", face:"smile", txt:"奴婢只在他枕畔留了一柄短匕。他若还想睡安稳觉，自会收敛。"},
     {who:"你", txt:"一夜三百里，刃不血而折其骄横……好一个夜阑潜锋。"},
     {who:"慕容璇", face:"pensive", txt:"奴婢这身手，伤人易，护人难。陛下要奴婢护谁，奴婢便护谁。"}],
   ...
   {at:85,title:"侠骨之许",text:"慕容璇本欲功成身退、飘然江湖，却为你「以天下为己任」之志所留。她收剑入鞘，垂首道：愿留君侧，为你守这万里河山……",join:true,
    script:[
     {cg:"3", txt:"夜深，演武场上只余一人一剑。慕容璇收势，望向你，眼神不再设防。"},
     {who:"慕容璇", face:"neutral", txt:"奴婢本是江湖人，功成之后，原想就此飘然远去，不问朝堂。"},
     {who:"你", txt:"那为何不走？"},
     {who:"慕容璇", face:"pensive", txt:"因为……奴婢见过太多枭雄争一城一池，却头一回见有人，把『天下苍生』四字，真放在心上。"},
     {txt:"她缓缓将剑收入鞘中，屈膝半跪。"},
     {who:"慕容璇", face:"blush", txt:"江湖路远，不及君侧三尺。"},
 ...
 {id:"furen", name:"安韶华", portrait:_PC+"furen_neutral.jpg", origin:"noble", woo:"charm", beauty:95, joinRank:4,
  ...
  scenes:[
   {at:25,title:"一顾倾城",text:"乐官于殿前歌：『北方有佳人，一顾倾人城，再顾倾人国。』你问世间果有此人，他垂首：臣有一妹，名安韶华……",
    script:[
     {cg:"1", txt:"殿前夜宴，乐官抚弦而歌：『北方有佳人，绝世而独立，一顾倾人城，再顾倾人国。』"},
     {who:"你", txt:"世间当真有此倾城之人？"},
     {who:"乐官", txt:"……臣有一妹，名唤安韶华。臣这支曲子，原是为她而作。"},
     {txt:"满座哗然。你心中那点好奇，再也按捺不住。"},
     {who:"你", txt:"（一顾倾城……朕倒要看看，是怎样一副颜色。）"}],
    choices:[{text:"叹『安得如此佳人』",eff:{charm:+1}},{text:"召其妹一见究竟",eff:{}}]},
   {at:55,title:"满殿生辉",text:"安韶华入觐，回眸一顾，满殿为之生辉，果真倾城之色。你自此朝思暮想，几废寝食——左右暗暗忧心。",
    script:[
     {cg:"2", txt:"安韶华入觐。她莲步轻移，行至殿心，抬眸，回眸一顾——"},
     {txt:"刹那间，满殿灯烛仿佛都暗了下去。果真倾城之色。"},
     {who:"安韶华", face:"neutral", txt:"臣女安韶华，叩见陛下。"},
     {who:"你", txt:"（朕自此……怕是要食不知味了。）"},
     {txt:"此后数日，你朝思暮想，几废寝食，左右皆暗暗忧心。"},
     {who:"安韶华", face:"pensive", txt:"陛下为臣女疏了朝政，臣女惶恐。红颜易老，江山却不能老啊。"}],
   ...
   {at:85,title:"倾城之恋",text:"韶华体弱而慧，深谙『以色事人者，色衰而爱弛』，从不以容自恃，反劝你勤勉朝政。今夜她浅笑相邀……",join:true,
    script:[
     {cg:"3", txt:"烛影摇红，韶华为你斟下一盏温酒，眉眼间却无半分恃宠之色。"},
     {who:"安韶华", face:"neutral", txt:"臣女自幼便知：以色事人者，色衰而爱弛。"},
     {who:"安韶华", face:"pensive", txt:"所以臣女从不敢以这副容貌自恃。臣女要的，是陛下勤勉天下、做个明君——"},
     {who:"安韶华", face:"smile", txt:"如此，纵有一日臣女红颜老去，陛下记得的，也不只是一张脸。"},
     {who:"你", txt:"倾城之貌，偏生一副不肯倾国的心肠。"},
